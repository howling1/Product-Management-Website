...
<html>
	...
	<body>
		<div id="addAll">
			<div id="nav">
				<p>Commodity Management>Update Commodity</p>
			</div>
...
<script type="text/javascript">
	function myclose(ispage) {
		$.ajax({
			...
			<div id="table">
				<form action="${pageContext.request.contextPath}/prod/updateProductInfo.action" enctype="multipart/form-data" method="post" id="myform">
