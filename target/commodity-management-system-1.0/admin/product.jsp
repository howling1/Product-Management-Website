...
<div id="brall">
    <div id="nav">
        <p>Commodity>Commodity List</p>
    </div>
    <div id="condition" style="text-align: center">
        <form id="myform">
            Commodity Name：<input name="pname" id="pname">&nbsp;&nbsp;&nbsp;
            Commodity Category：<select name="typeid" id="typeid">
            ...
            <input type="button" value="Search" onclick="conditionSearch()">
        </form>
    </div>
    <br>
    <div id="table">
        ...
        <c:choose>
                ...
                <div id="top">
                    ...
                    <a href="${pageContext.request.contextPath}/admin/addproduct.jsp">
                        ...
                        <input type="button" class="btn btn-warning" id="btn1"
                               value="Add Commodity" style="font-size: 15px">
                    </a>
                    <input type="button" class="btn btn-warning" id="btn1"
                           value="Batch Deletion" style="font-size: 15px" onclick="deleteBatch()">
                </div>
                <!--显示分页后的商品-->
                <div id="middle">
                        ...
                        <div>
                            <nav aria-label="..." style="text-align:center;">
                                <ul class="pagination">
                                    ...
                                    <li style=" margin-left:150px;color: #0e90d2;height: 35px; line-height: 35px;">totally&nbsp;&nbsp;&nbsp;<font
            ...
            <c:otherwise>
                <div>
                    <h2 style="width:1200px; text-align: center;color: orangered;margin-top: 100px">No matched commodities！</h2>
                </div>
            </c:otherwise>
        </c:choose>
    </div>
...
<script type="text/javascript">
    ...
    function deleteBatch() {
            ...
            //取得所有被选中删除商品的pid
            var selected_products=$("input[name=ck]:checked");
            var str="";
            var id="";
            if(selected_products.length==0){
                alert("Please select commodities you want to delete！");
            }else{
                // 有选中的商品，则取出每个选 中商品的ID，拼提交的ID的数据
                if(confirm("Are you sure to delete "+selected_products.length+" commodities？")){
                //拼接ID
                    $.each(selected_products,function (index,item) {
    ...
    function one(pid, pageNum) {
        location.href = "${pageContext.request.contextPath}/prod/getProductById.action?pid=" + pid + "&page=" + pageNum;
    }
</script>
<!--分页的AJAX实现-->
<script type="text/javascript">
    function ajaxsplit(pageNum) {
        ...
        url:"${pageContext.request.contextPath}/prod/ajaxSplit.action",
            ...
            type:"post",
            success:function () {
                //重新渲染页面http://localhost:8080/admin/product.jsp的组件table
                $("#table").load("${pageContext.request.contextPath}/admin/product.jsp #table");
            }
        })
    };
